...
- **압축 해제 후**: 약 320GB (44.1kHz / 16bit / mono × 1,012시간 기준 추정)
- **동시 보관 최대치**: 약 540GB → 여유 포함 **600GB 이상** 확보 권장
- **압축 해제 후 zip 삭제** 시 최종 점유는 약 320GB
...
기본값은 밑줄이 들어간 `./133.감성_및_발화_스타일_동시_고려_음성합성_데이터`인데,
실제 생성되는 폴더명은 **공백**이 들어간 이름일 수 있으므로 직접 잡아 주세요:
